...
export const data = {
  labels: ["Metals", "Gears", "Aluminum", "Screws", "Consumables", "Electronics"],
  datasets: [
    {
      label: "Nos of Votes",
      data: [10, 1, 5, 8, 9, 4],
        ...
        <article className="flex flex-col gap-4 rounded-lg border  border-gray-100 bg-white p-6  ">
          ...
          <div>
            ...
            <p>
              ...
              <span className="text-xs text-gray-500"> from ₱2,345,678.40 </span>
            </p>
          </div>
        </article>
        ...
        <article className="flex flex-col  gap-4 rounded-lg border border-gray-100 bg-white p-6 ">
          ...
          <div>
            ...
            <p>
              ...
              <span className="text-xs text-gray-500"> from ₱1,234,567.04</span>
            </p>
          </div>
        </article>
        <article className="flex flex-col   gap-4 rounded-lg border border-gray-100 bg-white p-6 ">
